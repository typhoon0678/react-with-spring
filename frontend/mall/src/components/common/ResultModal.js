...
function ResultModal({title, content, callbackFn}) {
    return (
        <div className="fixed top-0 left-0 z-[1055] flex h-full w-full justify-center bg-black-700 bg-opacity-20">
            ...
            <div
                ...
                <div className="text-4xl border-orange-400 border-b-4 pb-4">
                    {content}
                </div>

                <div className="justify-end flex">
                    <button className="rounded bg-blue-500 mt-4 px-6 pt-4 pb-4 text-lg text-white"
                            onClick={() => {
                                if (callbackFn) {
                                    callbackFn()
                                }
